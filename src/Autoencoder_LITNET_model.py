...
def build_LITNET_AE(rho=0.04):

    # first step is to define a AE and pre-training
    
    # Layer 1
    input_traffic = Input(shape=(36, ))
    encoded_1 = Dense(30, activation='relu')(input_traffic)
    encoded_1_bn = BatchNormalization()(encoded_1)
    decoded_1 = Dense(36, activation='relu')(encoded_1_bn)

    autoendoder_1 = Model(inputs=input_traffic, outputs=decoded_1)
    encoder_1 = Model(inputs=input_traffic, outputs=encoded_1_bn)

    # Layer 2
    encoded1_input = Input(shape=(30, ))
    encoded_2 = Dense(20, activation='relu')(encoded1_input)
    encoded_2_bn = BatchNormalization()(encoded_2)
    decoded_2 = Dense(30, activation='relu')(encoded_2_bn)

    autoendoder_2 = Model(inputs=encoded1_input, outputs=decoded_2)
    encoder_2 = Model(inputs=encoded1_input, outputs=encoded_2_bn)

    # Layer 3
    encoded2_input = Input(shape=(20, ))
    encoded_3 = Dense(10, activation='relu')(encoded2_input)
    encoded_3_bn = BatchNormalization()(encoded_3)
    decoded_3 = Dense(20, activation='relu')(encoded_3_bn)
	...
	# model
    model_input = Input(shape=(36,))
    model_encoded_1 = Dense(30, activation='relu')(model_input)
    model_encoded1_bn = BatchNormalization()(model_encoded_1)
    model_encoded_2 = Dense(20, activation='relu')(model_encoded1_bn)
    model_encoded2__bn = BatchNormalization()(model_encoded_2)
    model_encoded_3 = Dense(10, activation='relu')(model_encoded2__bn)
    model_encoded3__bn = BatchNormalization()(model_encoded_3)

    model_decoded_3 = Dense(20, activation='relu')(model_encoded3__bn)
    model_decoded_3_bn = BatchNormalization()(model_decoded_3)
    model_decoded_2 = Dense(30, activation='relu')(model_decoded_3_bn)
    model_decoded_2_bn = BatchNormalization()(model_decoded_2)
    model_decoded_1 = Dense(36, activation='relu')(model_decoded_2_bn)
