...
def build_NetML_AE(rho=0.04):

    # first step is to define a AE and pre-training
    
    # Layer 1
    input_traffic = Input(shape=(121, ))
    encoded_1 = Dense(100, activation='relu')(input_traffic)
    encoded_1_bn = BatchNormalization()(encoded_1)
    decoded_1 = Dense(121, activation='relu')(encoded_1_bn)
    ...
    encoded_2 = Dense(80, activation='relu')(encoded1_input)
    encoded_2_bn = BatchNormalization()(encoded_2)
    decoded_2 = Dense(100, activation='relu')(encoded_2_bn)

    autoendoder_2 = Model(inputs=encoded1_input, outputs=decoded_2)
    encoder_2 = Model(inputs=encoded1_input, outputs=encoded_2_bn)

    # Layer 3
    encoded2_input = Input(shape=(80, ))
    encoded_3 = Dense(60, activation='relu')(encoded2_input)
    encoded_3_bn = BatchNormalization()(encoded_3)
    decoded_3 = Dense(80, activation='relu')(encoded_3_bn)
	...
	# model
    model_input = Input(shape=(121,))
    model_encoded_1 = Dense(100, activation='relu')(model_input)
    model_encoded1_bn = BatchNormalization()(model_encoded_1)
    model_encoded_2 = Dense(80, activation='relu')(model_encoded1_bn)
    model_encoded2__bn = BatchNormalization()(model_encoded_2)
    model_encoded_3 = Dense(60, activation='relu')(model_encoded2__bn)
    model_encoded3__bn = BatchNormalization()(model_encoded_3)

    model_decoded_3 = Dense(80, activation='relu')(model_encoded3__bn)
    model_decoded_3_bn = BatchNormalization()(model_decoded_3)
    model_decoded_2 = Dense(100, activation='relu')(model_decoded_3_bn)
    model_decoded_2_bn = BatchNormalization()(model_decoded_2)
    model_decoded_1 = Dense(121, activation='relu')(model_decoded_2_bn)
